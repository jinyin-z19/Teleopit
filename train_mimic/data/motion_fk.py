...
def compute_npz_fk_consistency(
    ...
    *,
    ...
    # Root is always at index 0 in the NPZ by convention (set by convert_pkl_to_arrays).
    root_pos = body_pos_w[frame_indices, 0, :]
    root_quat_wxyz = body_quat_w[frame_indices, 0, :]
